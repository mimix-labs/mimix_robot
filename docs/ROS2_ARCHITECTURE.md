...
3. Probar físicamente el protocolo serial con el ESP32-C3 y las ruedas elevadas.
4. Incorporar sensores, servomotores, estados de movimiento y acciones reales.
